...
router.post('/addtopic', urlencodedParser, function (req, res) {
    ...
    if (req.session.username) {
        ...
        db.run("INSERT INTO Topic(title,createtime,creator,likes,description,code) VALUES (?,?,?,?,?,?)",
            topictitle, createtime, creator, 0, topic_dicription, topic_code, function (err) {
                if (err) {
